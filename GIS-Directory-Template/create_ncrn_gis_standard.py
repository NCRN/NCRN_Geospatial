...
workspace = r'C:\_GIS\TEST' ## Update this to be the directory where the geodatabase should be created
...
domains_list = ['DOM_DATAACCESS_NPS2016', 'DOM_ISEXTANT_NPS2016', 'DOM_LINETYPE_NPS2016', 'DOM_POINTTYPE_NPS2016', 'DOM_POLYGONTYPE_NPS2016',  
                'DOM_PUBLICDISPLAY_NPS2016', 'DOM_REGIONCODE_NPS2016', 'DOM_XYACCURACY_NPS2016', 'DOM_YES_NO_UNK_NPS2016', 'DOM_INDICATORCAT', 'DOM_HABITATDESC']
...
domain_values_list = [[arcpy.env.workspace, 'DOM_DATAACCESS_NPS2016', 'Unrestricted', 'Unrestricted'],
                      ...
                      [arcpy.env.workspace, 'DOM_REGIONCODE_NPS2016', 'WASO', 'WASO'],
                      ...
                      [arcpy.env.workspace, 'DOM_HABITATDESC', 'Forest', 'Forest'],
                      [arcpy.env.workspace, 'DOM_HABITATDESC', 'Grassland', 'Grassland'],
                      [arcpy.env.workspace, 'DOM_HABITATDESC', 'Creek', 'Creek'],
                      [arcpy.env.workspace, 'DOM_HABITATDESC', 'River/Stream', 'River/Stream'],
                      [arcpy.env.workspace, 'DOM_HABITATDESC', 'Wetland', 'Wetland'],
                      [arcpy.env.workspace, 'DOM_HABITATDESC', 'Lentic', 'Lentic'],
                      [arcpy.env.workspace, 'DOM_HABITATDESC', 'Lotic', 'Lotic'],
                      [arcpy.env.workspace, 'DOM_HABITATDESC', 'Other', 'Other'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Weather and climate', 'Weather and climate'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Water chemistry', 'Water chemistry'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Land cover and use', 'Land cover and use'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Invasive/exotic plants', 'Invasive/exotic plants'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Birds', 'Birds'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Surface water dynamics', 'Surface water dynamics'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Ozone', 'Ozone'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Wet and dry deposition', 'Wet and dry deposition'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Visibility and particulate matter', 'Visibility and particulate matter'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Fire and fuel dynamics', 'Fire and fuel dynamics'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Vegetation complexes', 'Vegetation complexes'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Mammals', 'Mammals'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Forest/woodland communities', 'Forest/woodland communities'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Soil function and dynamics', 'Soil function and dynamics'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Stream/river channel characteristics', 'Stream/river channel characteristics'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Aquatic macroinvertebrates', 'Aquatic macroinvertebrates'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Threatened and endangered species and communities', 'Threatened and endangered species and communities'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Air contaminants', 'Air contaminants'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Groundwater dynamics', 'Groundwater dynamics'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Amphibians and reptiles', 'Amphibians and reptiles'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Grassland/herb communities', 'Grassland/herb communities'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Fishes', 'Fishes'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Insect pests', 'Insect pests'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Riparian communities', 'Riparian communities'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Nutrient dynamics', 'Nutrient dynamics'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Primary production', 'Primary production'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Wetland communities', 'Wetland communities'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Microorganisms', 'Microorganisms'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Water toxics', 'Water toxics'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Invasive/exotic animals', 'Invasive/exotic animals'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Coastal/oceanographic features and processes', 'Coastal/oceanographic features and processes'],
                      [arcpy.env.workspace, 'DOM_INDICATORCAT', 'Other', 'Other']]
...
create_fcs_dict = {1:['ECO_MonitoringLocations_pt','POINT'], 2:['ECO_MonitoringLocationsData_pt','POINT'], 3:['ECO_MonitoringLocationsData_ln','POLYLINE'], 4:['ECO_MonitoringLocationsData_py','POLYGON']}
